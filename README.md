...
- `intl.reg`: Importable Windows registry file containing my preferred choices for number, date and time formats. Represents international/canonical formats that I find agreeable (similar to the `C` or `en_XX` locales for Linux). Also works in Wine!
